...
<body>
	  	...
	  	<div class="container">
		      ...
		      <form class="form-login" id="loginForm" name="loginForm" method="post">
		        ...
		        <div class="login-wrap">
		            <input type="text" class="form-control" id="j_username" name="j_username" placeholder="User ID" autofocus>
		            <br>
		            ...
		            <button class="btn btn-theme btn-block" onclick="checkDetails();"><i class="fa fa-lock"></i> SIGN IN</button>
		            <hr>
    ...
    <script type="text/javascript" src="<c:url value="/admin/assets/js/jquery.backstretch.min.js"/>"></script>
    <script>
